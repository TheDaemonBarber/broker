...
export const main = async (clientOpts: ClientOpts) => {
  try {
    ...
    if (
      ...
      await retrieveConnectionsForDeployment(clientOpts);
      // Reload config with connection
      loadBrokerConfig();
      const globalConfig = getConfig();
      clientOpsWithRemoteConfig = Object.assign(
        {},
        globalConfig,
        clientOpts,
    ...
    const loadedClientOpts: LoadedClientOpts = {
      ...
      ...(clientOpsWithRemoteConfig ?? clientOpts),
    };
